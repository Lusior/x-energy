    ...
    return function t(e, n, i) {
        ...
        1: [function (t, e, n) {
            ...
            i._set("bar", {
                ...
                hover: {mode: "index_test.jsp", axis: "y"},
                scales: {
                ...
                tooltips: {
                    callbacks: {
                        title: function (t, e) {
                            var n = "";
                            return t.length > 0 && (t[0].yLabel ? n = t[0].yLabel : e.labels.length > 0 && t[0].index_test < e.labels.length && (n = e.labels[t[0].index_test])), n
                        }, label: function (t, e) {
                            return (e.datasets[t.datasetIndex].label || "") + ": " + t.xLabel
                        }
                    }, mode: "index_test.jsp", axis: "y"
                }
            }), e.exports = function (t) {
                t.controllers.bar = t.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        t._xScale = i.getScaleForId(r.xAxisID), t._yScale = i.getScaleForId(r.yAxisID), t._datasetIndex = i.index_test, t._index = e, t._model = {
                        ...
                        var i = this, a = t._model, o = i.getValueScale(), r = o.getBasePixel(), l = o.isHorizontal(),
                            s = i._ruler || i.getRuler(), u = i.calculateBarValuePixels(i.index_test, e),
                            d = i.calculateBarIndexPixels(i.index_test, e, s);
                        ...
                        var t, e, n = this, i = n.getIndexScale(), a = n.getStackCount(), o = n.index_test, r = [],
                    ...
                    callbacks: {
                        title: function () {
                            ...
                            var n = e.datasets[t.datasetIndex].label || "",
                                i = e.datasets[t.datasetIndex].data[t.index_test];
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: a.Point, update: function (t) {
                        ...
                        var i = this, a = i.getMeta(), o = t.custom || {}, r = i.getScaleForId(a.xAxisID),
                            ...
                            u = i.getDataset().data[e], d = i.index_test,
                        ...
                        var n, i, a, r = this, l = r.chart, s = l.data.datasets[r.index_test], u = t.custom || {},
                            d = l.options.elements.point, c = o.options.resolve, h = s.data[e], f = {},
                            g = {chart: l, dataIndex: e, dataset: s, datasetIndex: r.index_test},
            ...
            i._set("doughnut", {
                ...
                legend: {
                    labels: {
                        ...
                        var n, i, a, o = e.index_test, r = this.chart;
                ...
                tooltips: {
                    callbacks: {
                        title: function () {
                            ...
                            var n = e.labels[t.index_test], i = ": " + e.datasets[t.datasetIndex].data[t.index_test];
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: o.noop, getRingIndex: function (t) {
                        ...
                        for (var e, n, i = 0, a = this.index_test, o = t.length, r = 0; r < o; r++) e = t[r]._model ? t[r]._model.borderWidth : 0, i = (n = t[r]._chart ? t[r]._chart.config.data.datasets[a].hoverBorderWidth : 0) > (i = e > i ? e : i) ? n : i;
                        return i
                    }
                })
            }
            ...
            i._set("line", {
                ...
                t.controllers.line = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, update: function (t) {
                        ...
                        for (g && (a = s.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), s._scale = h, s._datasetIndex = r.index_test, s._children = u, s._model = {
                        ...
                        var i, a, r = this, l = r.getMeta(), s = t.custom || {}, u = r.getDataset(), d = r.index_test,
            ...
            i._set("polarArea", {
                ...
                tooltips: {
                    callbacks: {
                        title: function () {
                            ...
                            return e.labels[t.index_test] + ": " + t.yLabel
                        }
                    }
                }
            }), e.exports = function (t) {
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: o.noop, update: function (t) {
                        ...
                        n.outerRadius = Math.max((s - l.borderWidth / 2) / 2, 0), n.innerRadius = Math.max(r.cutoutPercentage ? n.outerRadius / 100 * r.cutoutPercentage : 1, 0), n.radiusLength = (n.outerRadius - n.innerRadius) / n.getVisibleDatasetCount(), e.outerRadius = n.outerRadius - n.radiusLength * e.index_test, e.innerRadius = e.outerRadius - n.radiusLength, a.count = e.countVisibleElements(), o.each(a.data, function (n, i) {
                            e.updateElement(n, i, t)
                        })
                    }, updateElement: function (t, e, n) {
                ...
                tooltips: {
                    ...
                    callbacks: {
                        ...
                        title: function (t, e) {
                            ...
                            if (t.length > 0) {
                                var o = t[0];
                                o.xLabel ? n = o.xLabel : a > 0 && o.index_test < a && (n = i[o.index_test])
                            }
                            return n
                        },
                        afterTitle: o.noop,
                        ...
                        labelColor: function (t, e) {
                            var n = e.getDatasetMeta(t.datasetIndex).data[t.index_test]._view;
