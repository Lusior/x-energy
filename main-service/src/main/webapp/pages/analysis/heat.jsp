...
<script>
    ...
    $(function () {
        ...
        $("#analysis_heat_analysis").addClass("active");
        $("#analysis_heat_analysis").parents(".sub").show();
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#table').bootstrapTable(
                {
                    url: '${pageContext.request.contextPath}/basic/analysis/heat/list',
                    pagination: true,
                    dataField: 'rows',
                    striped: true,
                    method: 'post',
            ...
            $('#btn_download')
                .click(
                    function () {
                        $('#heat_form')
                            .attr("action",
                                "${pageContext.request.contextPath}/basic/analysis/heat/list/export");
                        $('#heat_form').submit();
                    });
        };
        return oInit;
