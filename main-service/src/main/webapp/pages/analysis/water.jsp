...
<script>
    ...
    $(function () {
        ...
        $("#analysis_water_analysis").addClass("active");
        $("#analysis_water_analysis").parents(".sub").show();
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#table').bootstrapTable(
                {
                    url: '${pageContext.request.contextPath}/basic/analysis/water/list',
                    // height: 555,
                    pagination: true,
                    dataField: 'rows',
                    striped: true,
            ...
            $('#btn_download')
                .click(
                    function () {
                        $('#water_form')
                            .attr("action",
                                "${pageContext.request.contextPath}/basic/analysis/water/list/export");
                        $('#water_form').submit();
                    });
        };
        return oInit;
    ...
    var setChar = function () {
        var sname = new Array(), ft3q = new Array();
        var jsonData = $('#table').bootstrapTable('getData');
        for (var i = 0; i < jsonData.length; i++) {
            sname[i] = jsonData[i].stand_name;
            ft3q[i] = jsonData[i].ft3q_total;
        }
        option.xAxis.data = sname;
        option.series.data = ft3q;
        myChart.clear();
        myChart.setOption(option);
    };
</script>
