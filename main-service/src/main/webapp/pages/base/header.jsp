...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap-reset.css">
    ...
    <link href="${pageContext.request.contextPath}/css/simplebootadminindex.min.css" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/slidebars.min.js"></script>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/common-scripts.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/layer/layer.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/merge_table_cells.js"></script>
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=pvfjaidzvlumKEifreK05xj40AcGn4Gj"></script>
    <script src="${pageContext.request.contextPath}/js/bootstrap-table/fixed-column/js/bootstrap-table-fixed-columns2.js?str=1"></script>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/js/bootstrap-table/fixed-column/css/bootstrap-table-fixed-columns2.css">
...
<body>
<header class="header white-bg" style="background-color:#66cccc;width:100%;top: 0;">
    <a href="#" class="logo"><img src="${pageContext.request.contextPath}/img/${sessionScope.COMPANY_ICON}" width="68">&nbsp;&nbsp;${sessionScope.COMPANY_TITLE}
        <span id="logoTxt"></span></a>
    ...
    <ul class="head-rpart">
        ...
        <li class="dropdown">
            ...
            <a data-toggle="dropdown" class="dropdown-toggle userNameTop" id="loginId"
               style=" float:left; line-height:30px; cursor:pointer;text-decoration:underline "></a>
    ...
    <div class="modal fade modal-dialog-center" id="modal-psinfo" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel panel-primary ud-info" style="margin:0;">
                            <ul class="panel-body">
                                <li><span style="width:200px;">登陆账号:</span><span id="udLoginName"
                                                                                 class="udOprName"></span></li>
                                <li><span style="width:200px;">操作员名称:</span><span id="udOprName"
                                                                                  class="udOprName"></span></li>
                                <li><span style="width:200px;">联系电话：</span><span id="udPhone" class="udPhone"></span>
                                </li>
                                ...
                                <li><span style="width:200px;">最后登陆时间：</span><span id="udLastDtTm"
                                                                                   class="udLastDtTm"></span></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="modal fade modal-dialog-center" id="modal-pwdchange" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog ">
            <div class="modal-content-wrap">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel panel-primary ud-info" style="margin:0;">
                            <form action="" id="pwdchange">
                                <ul class="panel-body">
                                    <li><span style="width:200px;">登陆信息：</span><span id="loginIdTxt"
                                                                                     class="admin-name"></span></li>
                                    <li><span style="width:200px;">原登陆密码：</span><input type="password"
                                                                                       class="form-control" id="pwdold">
                                    </li>
                                    <li><span style="width:200px;">新登陆密码：</span><input type="password"
                                                                                       class="form-control" id="pwdnew">
                                    </li>
                                    <li><span style="width:200px;">重复新登陆密码：</span><input type="password"
                                                                                         class="form-control"
                                                                                         id="pwdre"></li>
                                </ul>
                            </form>
