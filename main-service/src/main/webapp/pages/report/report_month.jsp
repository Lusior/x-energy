            ...
            <section class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row row-lg">
                        <div class="col-sm-12">
                            <table id="table" class="table" style="margin-top: 20px"></table>
                        </div>
                    </div>
                </div>
            </section>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#report_month").addClass("active");
        $("#report_month").parents(".sub").show();
        //初始化时间控件
        $("#tTime").val(getCurrMonth());
        //1.初始化Table
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#table').bootstrapTable({
                url: '${pageContext.request.contextPath}/report/month/list',
                pagination: true,
                dataField: 'rows',
                striped: true,
                method: 'post',
            ...
            $('#btn_download')
                .click(
                    function () {
                        $('#month_form')
                            .attr("action",
                                "${pageContext.request.contextPath}/report/month/list/export");
                        $('#month_form').submit();
                    });
        };
        return oInit;
