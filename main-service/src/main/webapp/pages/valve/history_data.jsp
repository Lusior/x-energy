                ...
                <div class="panel-body">
                    <div class="row row-lg">
                        <div class="col-sm-12">
                            ...
                            <select id="curveSelect" name="curveSelect" class="form-control" onchange="$('#historyTable').bootstrapTable('refresh')">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#historyTable').bootstrapTable({
                url: '${pageContext.request.contextPath}/valve/historyDataAjax',
                pagination: true,
                method: 'post',
                showRefresh: true,
